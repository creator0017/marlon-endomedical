...
const fallbackProducts = [
  ...
  { _id: '14', slug: 'cs-anterior-spinal-internal-fixator-csb1-csb2-bone-plate-series', name: 'CS Anterior Spinal Internal Fixator (CSB1 / CSB2 Bone Plate Series)', subtitle: 'Anterior Thoracolumbar Bone Plate System', category: 'spine-surgery', price: 'POA', inStock: true, image: '/products/CS Anterior Spinal Internal Fixator.png' },
  { _id: '15', slug: 'cl-mis-cervical-fusion-cage-ivn-series', name: 'CL MIS Cervical Fusion Cage (IVN Series)', subtitle: '3D-Printed Porous Cervical Fusion Implant', category: 'spine-surgery', price: 'POA', inStock: true, image: '/products/cl-mis-cervical-ivn.png' },
  { _id: '16', slug: 'cl-shaped-thoracolumbar-fusion-apparatus-ivo-series', name: 'CL Shaped Thoracolumbar Fusion Apparatus (IVO Series)', subtitle: '3D-Printed Bulleted Lumbar Fusion Cage', category: 'spine-surgery', price: 'POA', inStock: true, image: '/products/cl-shaped-thoracolumbar-ivo.png' },
  { _id: '17', slug: 'cl-large-fusion-cage-ivd-series', name: 'CL Large Fusion Cage (IVD Series)', subtitle: '3D-Printed ALIF / LLIF / OLIF Fusion System', category: 'spine-surgery', price: 'POA', inStock: true, image: '/products/cl-large-fusion-ivd.png' },
  { _id: '18', slug: 'adjustable-artificial-vertebral-body-fixation-system', name: 'Adjustable Artificial Vertebral Body Fixation System', subtitle: 'Expandable Corpectomy Prosthesis System', category: 'spine-surgery', price: 'POA', inStock: true, image: '/products/adjustable-vertebral-body.png' },
  { _id: '19', slug: '3d-porous-vertebral-prosthesis-model-ia-cervical-model-ib-lumbar', name: '3D Porous Vertebral Prosthesis (Model I-A Cervical & Model I-B Lumbar)', subtitle: '3D-Printed Corpectomy Vertebral Replacement', category: 'spine-surgery', price: 'POA', inStock: true, image: '/products/3d-porous-vertebral-prosthesis.png' },
